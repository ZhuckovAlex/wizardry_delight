...
public class FeatherChicken extends Animal implements IAnimatable {
    ...
    public FeatherChicken(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    public static void cowDropFeather(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        if (entity == null)
            return;
        {
        ...
        if (world instanceof Level _level && !_level.isClientSide()) {
            ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.FEATHER,2));
        ...
        if (world instanceof ServerLevel _level) {
            Entity entityToSpawn = new FeatherChicken2(ModEntityTypesWD.FEATHER_CHICKEN2.get(), _level);
    ...
    public InteractionResult mobInteract(Player player, InteractionHand interactionHand) {
        ...
        if (itemstack.is(Items.SHEARS) && !this.isBaby()) {
            ...
            cowDropFeather(world, x, y, z, entity, itemstack);
    ...
    public void aiStep() {
        ...
        if (!this.level.isClientSide && this.isAlive() && !this.isBaby() && !this.isChickenJockey() && --this.eggTime <= 0) {
            ...
            this.spawnAtLocation(InitItemsWD.EGG_OFF_A_MOTTLED_CHICKEN.get());
