...
public class RoseGhostyTears extends ItemNameBlockItem {
    public RoseGhostyTears(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(Screen.hasShiftDown()) {
            ...
            components.add(Component.translatable("wizardry_delight.rose_ghosty_tears").withStyle(ChatFormatting.DARK_PURPLE));
        } else {
